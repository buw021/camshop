...
const ManageOrder: React.FC<ManageOrderProps> = ({
  ...
  const currentOrder: OrderProps = order;
        ...
        {currentOrder ? (
          <>
            <div className="flex w-full items-center justify-between">
              ...
              <div className="flex items-center justify-center gap-0.5">
                <button
                  ...
                  onClick={prevPage}
                  style={{
                    opacity: currentOrderIndex === 0 ? 0.5 : 1,
                  }}
                >
                ...
                <button
                  ...
                  onClick={nextPage}
                  style={{
                    opacity: currentOrderIndex === totalOrders - 1 ? 0.5 : 1,
                  }}
                >
            ...
            <div className="ml-0.5 flex w-full items-center justify-between">
              ...
              <p className="text-sm font-medium tracking-wide text-zinc-500">
                Order{" "}
                <span className="text-zinc-700">{currentOrderIndex + 1} </span>
                out of <span className="text-zinc-700">{totalOrders}</span>
              </p>
            </div>
            ...
            <div className="flex w-full justify-end gap-2">
              ...
              {currentOrder.status === "refund on process" && (
                <button
                  ...
                  onClick={() => {
                    if (
                      window.confirm("Are you sure this order is refunded?")
                    ) {
