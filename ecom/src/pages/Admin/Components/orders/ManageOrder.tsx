              ...
              {(currentOrder.status === "shipped" ||
                ...
                <button
                  ...
                  if (trackingNo === currentOrder.trackingNo && trackingLink === currentOrder.trackingLink) {
                    showToast("Tracking number and link are unchanged", "info");
                    return;
                  }
            ...
            <button
              ...
              onClick={() => {
                if (
                  ...
                  fulfillOrder("fulfill", trackingLink, trackingNo);
                }
              }}
            >
              Fulfill Order
            ...
            <button
              ...
              onClick={() => {
                ...
                if (window.confirm("Update status to shipped?")) {
                  shipOrder("shipped", trackingNo, trackingLink);
                }
              }}
            >
              Ship Order
          ...
          {currentOrder.fulfilled && currentOrder.status === "delivered" && (
            <button
              ...
              onClick={() => {
                ...
                deliveredOrder("delivered", trackingNo, trackingLink);
              }}
            >
              Order Delivered
            </button>
